...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page1 = OnboardingViewController(heroImageName: "delorean", titleText: "Bankey is faster, easier to use, and has a brand new look and feel thath will make You feel like you are back in 1989.")
    ...
    private func setup() {
        ...
        // Adding child view controllers to parent view controller.
...
extension OnboardingContainerViewController {
    ...
    @objc private func backTapped(_ sender: UIButton) {
        ...
        pageViewController.setViewControllers([previousViewController], direction: .forward, animated: true)
    }
